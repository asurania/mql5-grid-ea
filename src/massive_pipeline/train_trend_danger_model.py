...
IN_FILE = Path("data/processed/modeling/trend_danger_training_dataset.parquet")
OUT_DIR = Path("data/models/trend_danger")
...
def main() -> None:
    ...
    model.save_model(str(OUT_DIR / "xgb_y_trend_danger.json"))
